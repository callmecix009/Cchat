...
const FAQ_DATA = [
  ...
  ["How do payments work?", "They don't — at least not inside Cchat. The AI simply tells customers your own methods (M-Pesa, Tigo Pesa, Airtel Money, cash…). Money moves between you and your customer, exactly like today."],
  ...
  ["What do I need to start?", "A WhatsApp Business number and about ten minutes to answer setup questions. No hardware, no developers."],
  ["Is there a contract?", "No. $5/month, managed externally, cancel anytime. Your inbox history stays exportable."],
];
    ...
    <div className="min-h-screen font-body text-dark">
      ...
      <header className="relative overflow-hidden bg-[#081811] text-[#EAF4EE] pt-[130px] pb-[70px] px-[5vw]">
        ...
        <div className="relative max-w-[720px] mx-auto text-center">
          ...
          <div className="text-[12.5px] text-[#8FAA99] font-medium mt-4">$5/month flat · No per-message fees · Cancel anytime</div>
        </div>
      </header>
            ...
            {[
              {
                ...
                desc: "Create your account, then answer a short setup wizard about your products, prices, services, delivery and policies — in your own words. Ten minutes, done once.",
      ...
      <section className="bg-surface text-dark py-[86px] px-[5vw]" id="pricing">
        <div className="max-w-[1200px] mx-auto">
          <div className="mx-auto mb-[44px] max-w-[640px] text-center">
            <div className="text-[12px] font-[800] tracking-[.16em] uppercase text-grn-d mb-[10px]">Pricing</div>
            <h2 className="font-disp font-[800] tracking-[-.02em] leading-[1.1] text-[clamp(28px,3.4vw,42px)]">
              One plan. Five dollars. That&apos;s it.
            </h2>
          </div>
          <div className="max-w-[480px] mx-auto bg-white rounded-[22px] p-[38px] shadow-[0_2px_4px_rgba(14,32,22,.06),0_12px_32px_-14px_rgba(14,32,22,.18)] relative border-t-[6px] border-grn">
            <span className="absolute -top-[15px] left-1/2 -translate-x-1/2 bg-[#081811] text-lime2 text-[11.5px] font-[800] tracking-[.1em] uppercase px-4 py-[6px] rounded-full whitespace-nowrap">
              Everything included
            </span>
            <div className="text-center">
              <div className="font-disp text-[64px] font-[800] tracking-[-.03em] leading-none">
                $5<small className="text-[18px] text-muted font-semibold">/month</small>
              </div>
              <div className="text-muted text-[14px] mt-[6px]">Flat. No setup fee. No per-message charges. Cancel anytime.</div>
            </div>
            <ul className="list-none my-[22px] grid gap-[10px]">
              {PRICING_FEATURES.map((f, i) => (
                <li key={i} className="flex gap-[10px] items-start text-[14px] text-dark">
                  <CheckIcon size={15} />
                  {f}
                </li>
              ))}
            ...
            <Link
              href="/sign-up"
              className="w-full inline-flex items-center justify-center gap-2 px-[18px] py-[10px] rounded-[10px] bg-grn text-white font-semibold text-[14px] hover:bg-grn-d transition-all shadow-[0_6px_16px_-6px_rgba(20,154,91,.5)]"
            >
              Start now <ArrowIcon size={16} />
            </Link>
            <p className="text-[12.5px] text-muted text-center mt-[14px] leading-[1.5]">
              The subscription is managed externally. Cchat <b className="text-dark">never</b> processes your customers&apos; payments — M-Pesa, Tigo Pesa, Airtel Money and cash go straight to you.
            </p>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-[#050F0A] text-[#8FAA99] pt-14 pb-[30px] px-[5vw]">
        <div className="max-w-[1200px] mx-auto grid grid-cols-2 md:grid-cols-[2fr_1fr_1fr_1fr] gap-9 pb-9 border-b border-[rgba(143,240,180,.1)]">
          <div>
            ...
            <p className="text-[13.5px] max-w-[280px] leading-[1.6]">
              The AI WhatsApp agent for small businesses. Built Swahili-first in Dar es Salaam. 🇹🇿
            </p>
          </div>
          <div>
        ...
        <div className="max-w-[1200px] mx-auto flex justify-between gap-3 pt-[22px] text-[12.5px] flex-wrap">
          <span>© 2026 Cchat. Flat $5/month — nothing else.</span>
